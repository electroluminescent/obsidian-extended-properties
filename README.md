...
Over the top go **finishes** - matte, sheen, mirror, foil, spectra, prism, opal, nebula, beacon, glitter, crackle, satin, weave, relief, hammered - applied to everything, to named values, or to a band of numbers. Each is a material rather than a picture of one: there is one light source for the whole screen, following your pointer, and every finish on every property answers to it together, so a foil catches the light as you move across the sheet. All of it is gradients and blend modes; nothing is downloaded, nothing is an image, and nothing runs on a timer. Reduced motion keeps the material and stops the light; Windows High Contrast stands the whole layer down.
