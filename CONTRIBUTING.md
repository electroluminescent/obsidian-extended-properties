...
2. Register the dictionaries in `src/main.ts` / each module's `index.ts` via `i18n.register("fr", <dict>, "Francais")` (mirroring the English registration), importing the JSON.
